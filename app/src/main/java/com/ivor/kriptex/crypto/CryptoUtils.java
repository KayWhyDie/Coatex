...
public class CryptoUtils {
    ...
    public static void createKeyStore(String certPath, String cn, KeyPair keyPair) {
        try {
            ...
            // Store the private key together with the certificate so KeyManagerFactory can initialize
            java.security.cert.Certificate[] chain = new java.security.cert.Certificate[]{certificate};
            keyStore.setKeyEntry("private", keyPair.getPrivate(), cn.toCharArray(), chain);
